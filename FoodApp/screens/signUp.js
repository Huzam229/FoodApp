        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 5 }}>
            <View style={[{ backgroundColor: themeColor1.bgcolor(0.6) }, tw`flex-1`]}>
                ...
                <View style={[{ borderTopRightRadius: 50, borderTopStartRadius: 50 }, tw` bg-white flex-1 px-8 pt-8`]}>
                    <View>
                        <Text style={tw`text-gray-600 ml-2 font-bold `}>Full Name</Text>
                        <TextInput
                            ...
                            value={name}
                        />
                        <Text style={tw`text-gray-600 ml-2 mt-1 font-bold`}>Email Address</Text>
                        <TextInput
                        ...
                        />
                        <Text style={tw`text-gray-600 ml-2  mt-1 font-bold`}>Password</Text>
                        <TextInput
                        ...
                        <TouchableOpacity
                            ...
                            style={[{ backgroundColor: themeColor1.bgcolor(0.8) }, tw`py-3 mx-7 rounded-2xl mt-4`]}>
                            <Text style={tw`text-white text-xl text-center font-bold`}>Sign Up</Text>
                        </TouchableOpacity>
                    </View>
